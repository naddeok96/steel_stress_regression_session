...
from sklearn.gaussian_process.kernels import ConstantKernel, Exponentiation, RBF, DotProduct, Sum
...
def k_fold_evaluation(X, y, k=5):
    ...
    for fold, (train_idx, test_idx) in enumerate(kf.split(X)):
        ...
        exp_kernel = ConstantKernel(1.0) * RBF(length_scale=1.0)
        
        # Combine the linear and exponential kernels using the Sum kernel
        kernel = Sum(exp_kernel, linear_kernel)
